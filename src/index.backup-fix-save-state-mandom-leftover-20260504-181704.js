...
const HOLY_CORPSE_PARTS = {
  ...
  spine: {
    ...
    emoji: "🦴",
    name: "Spine",
    description: "Parte sagrada ainda sem uso configurado."
  },
  rib_cage: {
    key: "rib_cage",
    emoji: "🫁",
...
function getHolyCorpseUsePreview(partKey) {
  ...
  if (normalizedPartKey === "spine") {
    return "🦴 Spine → parte sagrada ainda sem uso configurado.";
  }
...
function getHolyCorpseStandRewardV1(player, partKey) {
  ...
  if (partKey === "spine") {
    return {
      ...
      message: "🦴 A *Spine* ainda não possui Stand configurado. O Mandom foi removido do sistema."
    };
  }
if (partKey === "heart") {
...
function formatHolyCorpseInfoV1() {
  return [
    ...
    `🦴 Spine — parte sagrada ainda sem uso configurado`,
